...
import vista.RegistrarCitas;
import vista.RegistrarDoctor;
...
public class controladorSidebar implements  ActionListener, MouseListener, KeyListener {
    ...
    public controladorSidebar(menuSidebar vista){
        ...
        vista.BTN_PACIENTES.addMouseListener(this);
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        }else if (e.getSource() == vista.BTN_PACIENTES) {
            pacientes agen = new pacientes();
            vista.ventanaInicial.removeAll();
